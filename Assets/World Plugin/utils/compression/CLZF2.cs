...
public static class CLZF2
{
	...
	{
		//DisableLogging.Logger.Log ("Original file was " + inputBytes.Length + " bytes long.", Color.yellow);
		...
		//DisableLogging.Logger.Log ("Compressed file is " + outputBytes.Length + " bytes long.", Color.yellow);
		return outputBytes;
	}
